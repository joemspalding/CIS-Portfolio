...
namespace Prog4
{
    abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        // Postcondition: Returns a positive or negative number based on Title
        public int CompareTo(LibraryItem item)
        {
            ...
            // Returning the result of a string.CompareTo() method for ASC order.
